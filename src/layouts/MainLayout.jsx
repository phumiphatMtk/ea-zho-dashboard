...
const MainLayout = () => {
  ...
  const openProfileToolbar = Boolean(anchorEl);

  const handleProfileToolbarClick = (event) => {
    setAnchorEl(event.currentTarget);
  };
  const handleProfileToolbarClose = () => {
    setAnchorEl(null);
  };
  ...
  return (
    <>
          ...
          >
            <Box>
              <IconButton onClick={handleDrawerToggle}>
                {open ? (
                  <FormatIndentDecrease sx={{ color: "black" }} />
                ) : (
                  <FormatIndentIncrease sx={{ color: "black" }} />
                )}
              </IconButton>
            </Box>
            <Box>
              <Tooltip title="Account settings">
                <IconButton
                  onClick={handleProfileToolbarClick}
                  size="small"
                  sx={{ ml: 2 }}
                ...
                >
                  <Avatar sx={{ width: 32, height: 32, bgcolor: "#1677ff" }}>
                    M
                  </Avatar>
                </IconButton>
              </Tooltip>
      ...
      <Menu
        anchorEl={anchorEl}
        id="account-menu"
        open={openProfileToolbar}
        onClose={handleProfileToolbarClose}
        onClick={handleProfileToolbarClose}
        PaperProps={{
          elevation: 0,
          sx: {
            overflow: "visible",
      ...
      >
        <MenuItem onClick={handleProfileToolbarClose}>
          <Avatar sx={{ bgcolor: "#1677ff" }} /> Profile
        </MenuItem>
        <Divider />
        <MenuItem onClick={handleProfileToolbarClose}>
          <ListItemIcon>
